// Get Refresh token using username and password
// https://github.com/DoctorMcKay/node-steam-session


import {createInterface} from 'readline';
import {EAuthSessionGuardType, EAuthTokenPlatformType, EResult, LoginSession} from 'steam-session'; // use the following line if you installed the module from npm
